...
commentsRouter.get(
  '/:id',
  idValidation,
  async (req: RequestWithParams<CommentsIdParams>, res: Response<CommentsTypeOutput>) => {
...
commentsRouter.put(
  ...
  inputValidation,
  async (req: RequestWithParamsAndBody<CommentsIdParams, CommentsTypeInput>, res: Response) => {
...
commentsRouter.delete(
  ...
  bearerAuth,
  idValidation,
  async (req: RequestWithParams<CommentsIdParams>, res: Response) => {
