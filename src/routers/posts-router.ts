...
postsRouter.get(
    '/',
    queryValidation,
    async (req: RequestWithQuery<QueryPosts>, res: Response<PaginatedType<PostsTypeOutput>>) => {
...
postsRouter.get(
    '/:id',
    idValidation,
    async (req: RequestWithParams<PostsIdParams>, res: Response<PostsTypeOutput>) => {
...
postsRouter.post(
    ...
    blogIdValidation,
    inputValidation,
    async (req: RequestWithBody<PostsTypeInput>, res: Response<PostsTypeOutput | null>) => {
...
postsRouter.put(
    ...
    blogIdValidation,
    inputValidation,
    async (req: RequestWithParamsAndBody<PostsIdParams, PostsTypeInput>, res: Response) => {
